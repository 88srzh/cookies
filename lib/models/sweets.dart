...
class Sweets with ChangeNotifier {
  List<Sweet> _allSweets = [
    ...
    Sweet(
      ...
      likes: 0,
      description:
          '  Куриный бургер — отличная альтернатива обычному:\n благодаря птице, а не мясу в составе котлеты блюдо\n получается более легким и нежным. Кстати, такой\n вариант обычно очень нравится детям!',
      rating: 4.8,
      isFavourite: true,
      isPopular: true,
      sugar: '2',
